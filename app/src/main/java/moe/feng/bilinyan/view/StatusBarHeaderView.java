...
public class StatusBarHeaderView extends View {
	...
	public StatusBarHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		if (Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT) {
			this.setBackgroundColor(a.getColor(R.styleable.StatusBarHeaderView_colorNormal, 0));
		}
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
			this.setBackgroundColor(a.getColor(R.styleable.StatusBarHeaderView_colorDarker, 0));
		}
